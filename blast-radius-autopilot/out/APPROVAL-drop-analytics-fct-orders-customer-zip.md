...
| `save_document` | `urn:li:dataset:(urn:li:dataPlatform:snowflake,analytics.fct_orders,PROD)` | institutional-memory link -> file:///Users/adeel.tahir/Desktop/AIProject/DataHubHackathon/blast-radius-autopilot/out/ASSESSMENT-drop-analytics-fct-orders-customer-zip.md |
